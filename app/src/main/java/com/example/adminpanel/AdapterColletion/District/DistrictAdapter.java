package com.example.adminpanel.AdapterColletion.District;
...
public class DistrictAdapter extends RecyclerView.Adapter<DistrictAdapter.MyViewHolder> {
    ...
    public DistrictAdapter(Context mContext, ArrayList<Result> districts) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Glide.with(mContext)
                .load(ApiCollection.BaseUrl + districts.get(position).getDisctrictImage())
                .apply(options)
    ...
    private void onDeleteClick(ImageView delete, int position) {
        delete.setOnClickListener(v -> {
            try {
                ...
                builder.setTitle("Delete District");
                builder.setMessage("Are sure to delete district?");
